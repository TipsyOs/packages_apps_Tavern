...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int textPrimaryColor = context.getResources().getColor(R.color.material_deep_beer_500);
        int tabTextColor = context.getResources().getColor(R.color.material_deep_beer_500);
