...
package com.gzr.tavern.preference;
...
public class CategoryPreference extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        imageview.getDrawable().setColorFilter(getContext().getResources().getColor(
                  ThemeAccentUtils.isUsingWhiteAccent(mOverlayManager, mCurrentUserId) ? R.color.tavern_light_category_icon_tint : R.color.tavern_dark_category_icon_tint), PorterDuff.Mode.SRC_IN);
    }
}
